...
DO $$
BEGIN
  -- Only proceed if the build_order_material_requirements table exists
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'build_order_material_requirements') THEN
