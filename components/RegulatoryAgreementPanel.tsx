          ...
          <div className="pt-4 border-t border-gray-700">
            <label className="flex items-start gap-3 cursor-pointer group">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-gray-600 text-red-600 focus:ring-red-500 focus:ring-offset-gray-800 disabled:opacity-50"
              />
              <span className="text-sm text-gray-300 group-hover:text-white transition-colors">
                Revoke agreement and disable compliance features
              </span>
            </label>
          </div>
        </div>
