...
const Vendors: React.FC<VendorsProps> = ({ vendors }) => {
    // Defensive check for undefined/null vendors
    ...
    return (
        <div className="space-y-6">
            ...
            {safeVendors.length === 0 ? (
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg shadow-lg p-8 border border-gray-700 text-center">
                    <p className="text-gray-400 text-lg">No vendors found.</p>
                    <p className="text-gray-500 text-sm mt-2">Add your first vendor to get started.</p>
                </div>
            ) : (
