...
|----------|-------------|----------------|
| `VERCEL_ENV` | Current environment: `production`, `preview`, or `development` | ✅ Yes |
| `VERCEL_URL` | Deployment URL | ✅ Yes |
| `VERCEL_OIDC_TOKEN` | Authentication token with environment scope | ✅ Yes |
| `VERCEL_GIT_COMMIT_SHA` | Git commit hash | ✅ Yes |

### Manual Environment Variables

Variables you configure in Vercel Dashboard → Settings → Environment Variables:
...
- [ ] All environment variables configured in Vercel Dashboard → Production
